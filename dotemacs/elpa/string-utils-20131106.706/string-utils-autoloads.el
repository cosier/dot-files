...

;;;### (autoloads (string-utils-truncate-to string-utils-split string-utils-squeeze-url
;;;;;;  string-utils-squeeze-filename string-utils-plural-ending
;;;;;;  string-utils-propertize-fillin string-utils-pad-list string-utils-pad
;;;;;;  string-utils-quotemeta string-utils-escape-double-quotes
;;;;;;  string-utils-string-repeat string-utils-compress-whitespace
;;;;;;  string-utils-trim-whitespace string-utils-has-whitespace-p
;;;;;;  string-utils-has-darkspace-p string-utils-stringify-anything)
;;;;;;  "string-utils" "string-utils.el" (21188 40467 0 0))
...
;;;***

;;;### (autoloads nil nil ("string-utils-pkg.el") (21188 40467 324860
;;;;;;  36000))
